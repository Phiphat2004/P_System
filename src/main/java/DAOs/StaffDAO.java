...
public class StaffDAO {
    ...
    public int AddNew(Staff s) throws SQLException {
        String sql = "insert into [Staff](staffEmail,staffPassword, staffName, staffDayOfBirth, staffPhone, staffAddress, cccd) values (?,?,?,?,?,?,?);";
        ...
        try {
            ...
            if (rs.next()) {
                ...
                staff = new Staff(rs.getInt("staffID"), rs.getString("staffEmail"), rs.getString("staffPassword"), rs.getString("staffName"),
                        rs.getDate("staffDayOfBirth"), rs.getString("staffPhone"), rs.getString("staffAddress"),rs.getString("cccd"));
                return staff;
            }
        } catch (SQLException ex) {
            Logger.getLogger(StaffDAO.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void addStaff(String email, String name, String phone, String address, Date date, String password, String cccd) {
        try {
    ...
    public void updateStaff( String name, String phone, String address, Date date, String id, String cccd) {
        try {
