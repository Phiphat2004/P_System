                        ...
                        <tbody>
                            ...
                            <c:forEach items="${listUser}" var="o">
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle"><p>${o.userName}</p></td>
                                    <td class="align-middle"><p>${o.userEmail}</p></td>
                                    <td class="align-middle"><p>${o.userDOB}</p></td>
                                    <td class="align-middle"><p>${o.userPhone}</p></td>
                                    <td class="align-middle"><p>${o.userAddress}</p></td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
