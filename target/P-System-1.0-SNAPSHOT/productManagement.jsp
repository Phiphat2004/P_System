                        ...
                        <tbody id="data">
                            <c:forEach items="${list}" var="c">
                                ...
                                <tr>
                                    ...
                                    <td><img src='/P-System/${c.productImg}' alt="" width="80" height="80"></td>
                                    <td>${c.productName}</td>
                                    ...
                                    <td>${c.productDis}</td>
                                    <td>
                                        <a href="manageProduct?type=update&pid=${c.productID}" class="btn btn-primary text-white m-2" ><i class="fa fa-pencil p-1"></i></a>
