            ...
            <div id="editEmployeeModal" class="container mt-5 bg-white p-5 rounded-5">
                ...
                <form action="AdminManager" method="post" >
                    ...
                    <div>		
                        ...
                        <div class="form-group">
                            <label>Cccd</label>
                            <input type="text" name="cccd" id="cccd" class="form-control"  value="<%= staff.getCccd()%>"  pattern="[0-9]{13}$" required title="Please enter a valid phone number starting with 0 and followed by 13 digits">
                        <p id="cccderror"></p>
                        </div>
                    </div>
                    <div class="update">
