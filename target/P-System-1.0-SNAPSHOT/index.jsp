                ...
                <div id="sort" class="row">
                    <div class="row">
                        <%
                            ...
                            ArrayList<Product> productList = productDAO.getProductForGuest();
                            for (Product product : productList) {
                        %>
                        <a id="product" href="/P-System/Product/Detail/<%= product.getProductID()%>" class="m-5 col-sm-12 col-md-4 col-lg-2" style="text-decoration: none"
                           >
                            <div class="card h-100" style="width: 13rem;">
                                <img src="<%= product.getProductImg()%>" class="card-img " alt="product1">
                                <div class="card-body">
                                    <h5 class="card-title"> <%= product.getProductName()%></h5>
                                    <p class="card-text"> <span class="fw-bold rounded-2 text-white bg-danger p-1">Giá
                                            tiền:</span>
                                        <fmt:formatNumber pattern="###,###" value="<%= product.getProductPrice()%>"/> vnđ
                                    </p>
                                </div>
                            </div>
                        </a>
